...
reste le moteur GameCube/Wii. Ryubing 1.3.3, avec les correctifs locaux décrits
dans l'étude, exécute la Switch. Le salon, les places, le chef, les profils et
...
| Latence et endurance Switch | Partie prolongée avec quatre appareils distants ; mesurer le délai d'un appui vers l'écran. La source artificielle, le compteur du moteur et les images peintes sont trois mesures différentes. |
